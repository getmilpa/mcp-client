...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa MCP Client',
    nsPrefix: 'Milpa\\McpClient\\',
    installCommand: 'composer require milpa/mcp-client',
    repoUrl: 'https://github.com/getmilpa/mcp-client',
    pagesUrl: 'https://getmilpa.github.io/mcp-client/',
    heroParagraph: 'An <strong>MCP (Model Context Protocol) client</strong> for PHP — stdio and HTTP/SSE '
